...
##################################################################
# In this project, the "GDC TCGA Prostate Cancer (PRAD)" dataset from UCSC Xena was-
# analyzed, focusing on differential gene expression related to Gleason scores in
# prostate cancer. The dataset comprised a substantial number of prostate cancer samples,
# each profiled with a significant number of probes. The analysis involved categorizing these samples based on Gleason scores,
# identifying differentially expressed genes with a False Discovery Rate (FDR) threshold of 10%.
# Among these genes, ENSG00000156384, ENSG00000103855, and ENSG00000114503 were the top differentially expressed.
# Additionally, Gene Ontology (GO) terms and pathways associated with these genes were identified, 
#providing insights into the biological processes and pathways influenced by Gleason scores in prostate cancer.

#LINK: https://xenabrowser.net/datapages/?cohort=GDC%20TCGA%20Prostate%20Cancer%20(PRAD)&removeHub=https%3A%2F%2Fxena.treehouse.gi.ucsc.edu%3A443
